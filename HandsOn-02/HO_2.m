function varargout = HD02_Pratica1Piano(varargin)
...
function HO_2_OpeningFcn(hObject, eventdata, handles, varargin)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
fc1 = 512;                 % Frequ�ncia da nota D�
ger_sinal(fc1)             % Chamando a fun��o para gerar sinal, plotar e reprozudir
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
fc1 = 682.67;                 % Frequ�ncia da nota F�
ger_sinal(fc1)             % Chamando a fun��o para gerar sinal, plotar e reprozudir
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
fc1 = 768;                 % Frequ�ncia da nota Sol
ger_sinal(fc1)             % Chamando a fun��o para gerar sinal, plotar e reprozudir
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
fc1 = 853.3;                 % Frequ�ncia da nota L�
ger_sinal(fc1)             % Chamando a fun��o para gerar sinal, plotar e reprozudir
